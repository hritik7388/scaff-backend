...
const memberServices_1 = require("../services/memberServices");
const memeberSchema_1 = require("../schemas/memeberSchema");
const memeberData = new memberServices_1.AddMemberServices();
    ...
    addNewMember(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const data = memeberSchema_1.addMemberSchema.parse(req.body);
