    ...
    addNewMemberServices(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!userData) {
                    throw new customError_1.CustomError("SuperADmin not found", 404, "Company not found");
                }
                ...
                return {
                    message: `Member ${newUser.name} added successfully`,
                    data: Object.assign(Object.assign({}, newUser), { id: newUser.id.toString() }),
                };
            }
            catch (error) {
